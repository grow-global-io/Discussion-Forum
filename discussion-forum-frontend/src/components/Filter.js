      ...
      {showMore && (
        <form className={styles.form} onSubmit={handleFilter}>
          ...
          <FormControl
            ...
            InputLabelProps={{ style: { fontSize: "12px" } }}
          >
            <InputLabel id="totalCommissionFee" sx={{ fontSize: 12 }}>
            ...
            <Select
              ...
              sx={{ fontSize: "12px" }}
              value={formData.totalCommissionFee}
              label="Total Commission Fee"
            >
          ...
          <FormControl
            ...
            InputLabelProps={{ style: { fontSize: "12px" } }}
          >
            <InputLabel id="partnerFees" sx={{ fontSize: "12px" }}>
          ...
          >
            ...
            <Select
              ...
              sx={{ fontSize: "12px" }}
            >
              <MenuItem value="Fixed" sx={{ fontSize: "12px" }}>
                Fixed
              </MenuItem>
              <MenuItem value="Flexible" sx={{ fontSize: "12px" }}>
                Flexible
              </MenuItem>
            </Select>
          </FormControl>
